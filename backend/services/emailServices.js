            ...
            ticketToday.forEach(async (ticket) => {
                ...
                let info = await transporter.sendMail({
                    ...
                    html: `<p style='text-align: justify;'><span style='color: #b96ad9;'><strong>Xin chào ${ticket.tentaiKhoan.hoTen},</strong></span></p>
                            ...
                            <p style="padding: 12px; border-left: 4px solid #d0d0d0; font-style: italic; text-align: justify;">Phim ${ticket.phim.tenPhim}&nbsp;chiếu v&agrave;o<span style="background-color: #ffffff;"> <strong>${ticket.maLichChieu.ngayChieu}</strong></span></p>
